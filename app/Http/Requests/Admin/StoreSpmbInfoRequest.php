...
class StoreSpmbInfoRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'banner_url' => 'required|file|mimes:jpg,jpeg,png,webp|max:2048',
    ...
    {
        return [
            'banner_url.required' => 'Banner paket SPMB wajib diunggah.',
