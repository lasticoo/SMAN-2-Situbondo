...
<div class="min-h-screen bg-slate-100">
    ...
    <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-4 sticky top-0 z-10 shadow-sm">
        ...
        <div>
            <h1 class="text-xl font-bold text-slate-800">Edit Banner</h1>
            <p class="text-sm text-slate-500 mt-0.5">Perbarui data banner <strong>{{ $banner->title }}</strong>.</p>
        </div>
    </header>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mb-3 flex items-center gap-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 break-all mt-0.5">{{ basename($banner->image_url) }}</p>
                            </div>
                        </div>
                        @endif

                        {{-- Drop zone untuk gambar baru --}}
                        <label
                            for="image"
                            id="dropzone"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            @php $isActive = old('is_active', $banner->is_active ? '1' : '0') == '1'; @endphp
