...
<div class="min-h-screen bg-slate-100">
    ...
    <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-4 sticky top-0 z-10 shadow-sm">
        ...
        <div>
            <h1 class="text-xl font-bold text-slate-800">Tambah Pop-up Event</h1>
            <p class="text-sm text-slate-500 mt-0.5">Isi form di bawah untuk menambahkan pop-up event.</p>
        </div>
    </header>
    ...
    <main class="p-6 max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <form
                method="POST"
                action="{{ route('admin.popups.store') }}"
                enctype="multipart/form-data"
                id="form-popup-create"
            >
                @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-1.5">
                            Gambar Pop-up <span class="text-red-500">*</span>
                        </label>
        ...
        {{-- Info Box: Cara Kerja Periode --}}
        <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl flex gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <div>
                <p class="text-sm font-semibold text-blue-800">Cara Kerja Periode Tampil</p>
                <p class="text-xs text-blue-700 mt-0.5">Pop-up hanya akan muncul di website user jika: (1) Status <strong>Aktif</strong>, dan (2) Tanggal hari ini berada di antara Tanggal Mulai dan Tanggal Selesai. Pop-up di luar periode atau nonaktif tidak akan ditampilkan.</p>
            </div>
        </div>
    </main>
</div>
