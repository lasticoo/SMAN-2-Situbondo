...
@php
    $pageTitle = 'SIKLUS - Sistem Informasi Kelulusan Siswa | SMAN 2 Situbondo';
    $pageDescription = 'Fitur Sistem Informasi Kelulusan Siswa (SIKLUS) dan Cek Status Kelulusan & SKL Online SMAN 2 Situbondo sedang dalam proses pengembangan.';
...
<style>
    ...
    .animate-wrench {
        ...
        animation: wrench-swing 2.8s ease-in-out infinite;
    }
    ...
    @media (prefers-reduced-motion: reduce) {
        .animate-float, .animate-spin-cw, .animate-spin-ccw, .animate-hammer, .animate-wrench, .animate-spark, .animate-progress-stripes {
...
<div class="min-h-screen flex flex-col justify-between bg-slate-950 text-slate-800 antialiased selection:bg-amber-100 selection:text-amber-900 overflow-x-hidden">
    ...
    <div>
        ...
        <!-- ------------------------------------------------------------- -->
        <!-- 2. HERO PANGGUNG SIKLUS: FITUR SEDANG DALAM PENGEMBANGAN       -->
        <!-- ------------------------------------------------------------- -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
                    ...
                    <div class="lg:col-span-6 space-y-5 sm:space-y-6 text-left" data-aos="fade-right" data-aos-duration="700">
                        ...
                        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-theme-secondary text-slate-950 text-xs font-black uppercase tracking-wider shadow-md">
                            ...
                            <span>SIKLUS • SISTEM KELULUSAN &amp; SKL</span>
                        </div>
                        ...
                        <div class="space-y-2">
                            <h1 class="text-3xl sm:text-4xl md:text-5xl font-black font-headline tracking-tight text-white leading-tight drop-shadow-md">
                                Fitur Sedang Dalam <span class="text-theme-secondary">Pengembangan</span>
                            </h1>
                        ...
                        <p class="text-sm sm:text-base text-slate-200 leading-relaxed font-normal max-w-xl">
                            Portal resmi pengecekan status kelulusan peserta didik dan pengunduhan Surat Keterangan Lulus (SKL) digital SMAN 2 Situbondo sedang dipersiapkan oleh tim pengembang untuk memberikan pelayanan terbaik, cepat, dan terverifikasi secara digital.
                        </p>
                        ...
                        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-5 border border-white/15 shadow-xl max-w-xl space-y-3">
                            <div class="flex items-center justify-between text-xs font-extrabold uppercase tracking-wider text-slate-200">
                                <span class="flex items-center gap-2">
                                    <i class="fas fa-tools text-theme-secondary animate-bounce"></i>
                                    <span>Tahap Integrasi Database &amp; SKL</span>
                                </span>
                                <span class="text-theme-secondary font-black text-sm">85%</span>
                            </div>

                            <!-- Progress Track & Bar -->
                            <div class="w-full h-3.5 bg-slate-900/70 rounded-full overflow-hidden p-0.5 border border-white/10">
                                <div class="h-full bg-theme-secondary rounded-full animate-progress-stripes transition-all duration-1000 shadow-sm" style="width: 85%;"></div>
                            </div>
                            ...
                            <p class="text-[11px] sm:text-xs text-slate-300 flex items-center gap-1.5">
                                ...
                                <span>Akan segera dapat diakses menjelang periode kelulusan siswa tahun ajaran berjalan.</span>
                            </p>
                        </div>
                    ...
                    <div class="lg:col-span-6 flex items-center justify-center" data-aos="fade-left" data-aos-duration="700">
                        <div class="relative w-full max-w-lg aspect-square sm:aspect-[4/3] rounded-3xl bg-slate-950/70 border-2 border-white/15 p-6 sm:p-8 shadow-2xl backdrop-blur-xl flex items-center justify-center overflow-hidden ring-1 ring-white/10 group">
                            ...
                            <svg viewBox="0 0 400 320" class="w-full h-full relative z-10 drop-shadow-2xl" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ilustrasi Pekerja Membangun Fitur Siklus">
                                ...
                                <g transform="translate(50, 60)">
                                    ...
                                    <!-- Right Arm with Animated Wrench / Hammer Working on System -->
        ...
        <!-- ------------------------------------------------------------- -->
        <!-- 3. PREVIEW RENCANA FITUR SIKLUS (3 CLEAN CARDS)              -->
        <!-- ------------------------------------------------------------- -->
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                ...
                <div class="text-center max-w-2xl mx-auto mb-10 sm:mb-12" data-aos="fade-up">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 font-headline">
                        Apa Saja yang Akan Hadir di <span class="text-theme-primary">SIKLUS</span>?
                    </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <!-- Card 1: Cek Kelulusan Siswa -->
                    <div class="bg-white rounded-2xl p-6 sm:p-7 border border-gray-200/90 shadow-sm hover:shadow-md transition-all spring-hover flex flex-col justify-between" data-aos="fade-up" data-aos-delay="100">
                        <div class="space-y-3.5">
                            ...
                            <h3 class="text-lg font-bold text-slate-900 font-headline">Cek Status Kelulusan NISN</h3>
                            <p class="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
                                Siswa kelas XII dapat langsung mengecek status kelulusan secara mandiri cukup dengan memasukkan NISN dan tanggal lahir secara aman.
                            </p>
                        </div>
                    ...
                    <!-- Card 2: Unduh SKL Digital -->
                    <div class="bg-white rounded-2xl p-6 sm:p-7 border border-gray-200/90 shadow-sm hover:shadow-md transition-all spring-hover flex flex-col justify-between" data-aos="fade-up" data-aos-delay="200">
                        <div class="space-y-3.5">
                            <div class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center text-xl shadow-2xs border border-amber-100">
                                <i class="fas fa-file-pdf"></i>
                            </div>
                            <h3 class="text-lg font-bold text-slate-900 font-headline">Unduh SKL &amp; Transkrip Digital</h3>
                            <p class="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
                                Dapatkan Surat Keterangan Lulus (SKL) resmi berformat PDF lengkap dengan nilai ujian dan QR Code verifikasi keabsahan dokumen.
                            </p>
                        </div>
                        <div class="pt-4 border-t border-gray-100 mt-4 flex items-center text-xs font-bold text-theme-primary">
                            <i class="fas fa-qrcode text-theme-secondary mr-1.5"></i>
                            <span>Verifikasi QR Code Resmi</span>
                        </div>
                    </div>

                    <!-- Card 3: Keamanan & Privasi Terjamin -->
                    <div class="bg-white rounded-2xl p-6 sm:p-7 border border-gray-200/90 shadow-sm hover:shadow-md transition-all spring-hover flex flex-col justify-between" data-aos="fade-up" data-aos-delay="300">
                        <div class="space-y-3.5">
                            <div class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-xl shadow-2xs border border-emerald-100">
                                <i class="fas fa-shield-alt"></i>
                            </div>
                            <h3 class="text-lg font-bold text-slate-900 font-headline">Privasi &amp; Keamanan Data</h3>
                            <p class="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
                                Data kelulusan terlindungi dengan sistem otentikasi ketat untuk memastikan kerahasiaan dan integritas nilai setiap peserta didik.
                            </p>
                        </div>
                        <div class="pt-4 border-t border-gray-100 mt-4 flex items-center text-xs font-bold text-theme-primary">
                            <i class="fas fa-lock text-theme-secondary mr-1.5"></i>
                            <span>Terenkripsi &amp; Terlindungi</span>
                        </div>
                    </div>
